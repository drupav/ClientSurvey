describe("SessionManager", function() {
  ...
  describe("Session start", function() {
    beforeEach(function() {
      this.session = this.sessionManager.get({userId: "test_user", accessToken: "test_key"});
    });
    ...
    it("should return a session with the user", function() {
      expect(userConstructor).toHaveBeenCalledWith({userId: "test_user", accessToken: "test_key"});
      expect(this.session).toEqual({user: {id: "test_user"}});
    });
  });
